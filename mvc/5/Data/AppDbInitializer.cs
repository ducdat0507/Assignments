    ...
    public static void Initialize(AppDbContext context)
    {
        ...
        if (context.Students.FirstOrDefault() == null)
        {
            ...
            var bogus = new Faker<Student>("vi")
                ...
                .RuleFor(o => o.FirstName, (f, o) => f.Name.LastName((Bogus.DataSets.Name.Gender)o.Gender!))
                .RuleFor(o => o.SecondName, (f, o) => f.Name.FirstName((Bogus.DataSets.Name.Gender)o.Gender!))
